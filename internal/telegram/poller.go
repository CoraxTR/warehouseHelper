...
//
// Курсор offset хранится в памяти: после перезапуска приложения Telegram
// (в пределах 24 ч) может повторить необработанные нажатия — повторная
// обработка безопасна (ответ на кнопку — ещё одна карточка в чате).
