...
func TestTransferAndZeroPrev(t *testing.T) {
...
func TestRollbackInEventfulWeek(t *testing.T) {
	s := newSeries(PeriodWeek)
...
func TestRollbackInCleanWeekNoop(t *testing.T) {
	s := newSeries(PeriodWeek)
...
func TestMutualZeroKeepsChainAlive(t *testing.T) {
	s := newSeries(PeriodWeek)
...
func TestUnavailableKeepsValue(t *testing.T) {
	s := newSeries(PeriodWeek)
...
func TestRollbackDiscountKeepsMinusOne(t *testing.T) {
	s := newSeries(PeriodWeek)
...
func TestRepeatedEventsStack(t *testing.T) {
	s := newSeries(PeriodWeek)
	s.apply(EventSoldOut, w1)
	s.apply(EventSoldOut, w1)
...
func TestCleanWeekBreaksChain(t *testing.T) {
	s := newSeries(PeriodWeek)
	s.apply(EventSoldOut, w1) // w1 = 1
...
func TestRollbackDoesNotTouchTransferredValue(t *testing.T) {
	s := newSeries(PeriodWeek)
	s.apply(EventSoldOut, w1)     // w1 = 1
...
func TestPeriodStartWeek(t *testing.T) {
	...
	got := PeriodStart(PeriodWeek, time.Date(2026, time.September, 1, 12, 0, 0, 0, time.UTC))
