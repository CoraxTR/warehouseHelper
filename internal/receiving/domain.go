...
type Cache struct {
	...
	// NoItemCode — ни одно товарное правило не вычитывает код товара: скан сам
	// товар не определит, поэтому товар задаёт оператор — выбор в шапке партии,
	// дальше все сканы становятся единицами этого товара (вес — из кода).
