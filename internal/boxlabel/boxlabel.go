...
// наименование, вес с вложениями, нижний отступ. Сумма — ровно высота листа
// (120 мм), поэтому наклейка печатается 1:1 без масштабирования.
var rowHeightMM = []float64{6, 32, 10, 26, 21, 25}
