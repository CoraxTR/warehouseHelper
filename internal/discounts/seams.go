...
//
// nil = скидка не задана (в БД NULL), 0 допустим: движок пишет NULL, а не 0,
// а легаси-ноль в plain-колонке читатели трактуют как «скидки нет» (движок
// в discount_general/discount_telegram управляет значением сайта).
// РУЧНЫЕ колонки (discount_general_manual/discount_telegram_manual) живут по
// другому правилу: 0 там значит «скидка 0 %» и замораживает пару — этот шов
// ручных колонок не касается (решение владельца, сентябрь 2026).
